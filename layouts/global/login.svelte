    ...
    <div class="modal-wrapper" on:click={removeHash}>
        <div class="modal" on:click|stopPropagation>
            ...
            <section class="content-wrapper staff">
                <h1>Admin Login</h1>
                <button class="gitlab" on:click|preventDefault={staffLogin}>
                    <svg width="50px" height="50px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" class="icon" fill="#fc6d26">
